...
(function () {
  ...
  /**
   * Return the cnpj with Mask (99.999.999/9999-99). We can pass number and characters since is a
   * valid cnpj, if it is not a valid, return true, otherwise, return this formatted
   *
   * @param {String} cnpj
   * @returns {*}
   */
  ...
  /**
   * Return a valid and fake cnpj with or without mask, if the argument withMask is true, this
   * will return with mask (99.999.999/9999-99), otherwise, it will return only numbers
   *
   * @param withMask
   * @returns {*}
   */
